...
Covers the Community tab's landing feed: a chronological post feed (not the groups directory), post detail navigation, publishing posts, and reachability of the groups directory as a secondary destination.
