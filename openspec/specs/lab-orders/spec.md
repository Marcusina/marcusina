...
Covers a patient's ability to view and manage their laboratory and imaging orders: the orders list, per-order status tracking, and choosing a preferred diagnostic center for a pending order.
