...
Covers moving from a confirmed, scheduled consultation appointment into the pre-consultation waiting room, and routing from there to the correct live-session screen based on consult type.
