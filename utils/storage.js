...
export const getToken = async () => {
  try {
    if (Platform.OS === "web") {
      ...
      // Retrieves securely from Keychain/Keystore
...
export const removeToken = async () => {
  try {
    if (Platform.OS === "web") {
      ...
      // Wipes it cleanly from secure hardware storage
...
export const getTheme = async () => {
  try {
    if (Platform.OS === "web") {
      ...
      return await AsyncStorage.setItem(THEME_KEY);
    }
  } catch (e) {
...
export const savePhoneSkipped = async () => {
  try {
    if (Platform.OS === "web") {
      ...
      await AsyncStorage.setItem(SKIP_PHONE_KEY, "true");
    }
  } catch (e) {
...
export const getPhoneSkipped = async () => {
  try {
    if (Platform.OS === "web") {
      ...
      return (await AsyncStorage.getItem(SKIP_PHONE_KEY)) === "true";
    }
  } catch (e) {
...
export const removePhoneSkipped = async () => {
  try {
    if (Platform.OS === "web") {
      ...
      await AsyncStorage.removeItem(SKIP_PHONE_KEY);
    }
  } catch (e) {
...
export const saveRoleProfileCreated = async () => {
  try {
    if (Platform.OS === "web") {
      ...
      await AsyncStorage.setItem(ROLE_PROFILE_CREATED_KEY, "true");
    }
  } catch (e) {
...
export const getRoleProfileCreated = async () => {
  try {
    if (Platform.OS === "web") {
      ...
      return (await AsyncStorage.getItem(ROLE_PROFILE_CREATED_KEY)) === "true";
    }
  } catch (e) {
...
export const removeRoleProfileCreated = async () => {
  try {
    if (Platform.OS === "web") {
      ...
      await AsyncStorage.removeItem(ROLE_PROFILE_CREATED_KEY);
    }
  } catch (e) {
